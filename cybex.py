...
# prompt user for amount and quality of data to be shared
...
V1 = (b * (math.log(1 + (Sc * Q)))) - Ra
V2 = (b * (math.log(1 + (s * q)))) - Ra

# calculate sharing utility
share1 = V1 * (a * math.log10(1 + I)) - x - c
share2 = V2 * (a * math.log10(1 + I)) - x - c
...
# print results
print '************************************'
print 'Current Value with CYBEX: ',V1
print 'Current Value without CYBEX: ',V2
...
print 'Utility for Sharing (firm only): ',share1
print 'Utility for Sharing (with CYBEX): ',share2
...
with open('/home/jay/Documents/cybex.txt','w') as outfile:
	outfile.write(str(I) + '\n')
	outfile.write(str(Q) + '\n')
